...
const JobDetailPage = () => {
    ...
    const isExpired = job.expiredAt ? new Date(job.expiredAt) < new Date() : false;
    ...
    return (
        <div className="bg-gray-50 min-h-screen py-8 pt-24">
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                {isExpired && (
                    <div className="bg-red-50 border border-red-200 text-red-600 p-4 rounded-xl mb-6 flex items-center gap-3 font-bold animate-pulse">
                        <AlertCircle size={24} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        {/* Header Card */}
                        <div className={`bg-white rounded-xl shadow-sm border border-gray-100 p-6 ${isExpired ? 'opacity-80' : ''}`}>
                            <h1 className="text-3xl font-bold text-gray-900 mb-4 font-heading">{job.title}</h1>
                            ...
                            <div className="flex flex-wrap gap-4 text-gray-600 mb-6">
                                ...
                                <span className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium ${isExpired ? 'bg-red-50 text-red-500' : 'bg-gray-50 text-orange-500'}`}>
                                    <Clock size={18} />
                                    {isExpired ? 'Đã hết hạn' : `Hạn nộp: ${job.expiredAt ? new Date(job.expiredAt).toLocaleDateString('vi-VN') : 'Đang cập nhật'}`}
                                </span>
                            </div>

                            {isExpired ? (
                                <div className="w-full md:w-auto bg-gray-200 text-gray-500 font-bold py-3 px-8 rounded-lg flex items-center justify-center gap-2 cursor-not-allowed border border-gray-300">
                                    <XCircle size={20} />
                                ...
                                <button
                                    ...
                                    className="w-full md:w-auto bg-ptit-red text-white font-bold py-3 px-8 rounded-lg hover:bg-ptit-darkred transition-all shadow-lg shadow-red-200 flex items-center justify-center gap-2 active:scale-95"
                                >
                                    <Upload size={20} />
                                    Ứng tuyển ngay
                                </button>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                            <h2 className="text-xl font-bold text-gray-900 mb-4 border-l-4 border-ptit-red pl-3 font-heading">Mô tả công việc</h2>
                        ...
                        {/* Requirements */}
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                            <h2 className="text-xl font-bold text-gray-900 mb-4 border-l-4 border-ptit-red pl-3 font-heading">Yêu cầu ứng viên</h2>
                        ...
                        {/* Benefits */}
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                            <h2 className="text-xl font-bold text-gray-900 mb-4 border-l-4 border-ptit-red pl-3 font-heading">Quyền lợi</h2>
                            <ul className="space-y-3">
            ...
            {showApplyForm && (
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl w-full max-w-lg p-8 animate-fade-in-up shadow-2xl relative">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mb-2 font-heading">Ứng tuyển ngay</h2>
                        <h3 className="text-ptit-red font-medium mb-6 font-heading">{job.title}</h3>
                        ...
                        <form className="space-y-4" onSubmit={handleApply}>
                            ...
                            <button 
                                type="submit" 
                                disabled={applying}
                                className="w-full bg-ptit-red text-white font-bold py-3 rounded-lg hover:bg-ptit-darkred transition-all mt-4 disabled:opacity-70 active:scale-95"
                            >
                ...
                <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
                    <div className="bg-white rounded-[3rem] w-full max-w-lg p-12 text-center shadow-2xl animate-fade-in-up relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <h2 className="text-3xl font-black text-gray-900 mb-4 tracking-tight font-heading">Nộp hồ sơ thành công!</h2>
                            ...
                            <div className="flex flex-col gap-4">
                                <Link 
                                    to="/applied-jobs" 
                                    className="w-full bg-ptit-red text-white font-black py-4 rounded-2xl hover:bg-ptit-darkred transition-all shadow-xl shadow-red-200 flex items-center justify-center gap-2 group active:scale-95"
                                >
                                    Xem việc làm đã nộp
