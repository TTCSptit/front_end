      ...
      <section className="py-20 bg-transparent border-t border-gray-100/50">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20">
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Viettel_logo_2021.svg" alt="Viettel" className="h-9 md:h-11 object-contain opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300 cursor-pointer hover:scale-105" />
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/7/77/VNPT_Logo.svg" alt="VNPT" className="h-10 md:h-12 object-contain opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300 cursor-pointer hover:scale-105" />
            <img src="https://upload.wikimedia.org/wikipedia/commons/2/24/Samsung_Logo.svg" alt="Samsung" className="h-5 md:h-6 object-contain opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300 cursor-pointer hover:scale-105" />
          </div>
        </div>
      </section>
    </>
